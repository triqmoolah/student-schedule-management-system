 ...
 * Application class for the University database
 */
public class Application {
	...
	/**
	 * Writes the course database to a file
	 * @param courseList
	 */
	...
	/**
	 * drops a course from the course database
	 * @param course
	 * @return
	 */
	...
	/**
	 * view the students in the database
	 * @return
	 */
	...
	/**
	 * determine if a students password exists in the database
	 * @param pass
	 * @return
	 */
	...
	/**
	 * determine if a students name exists in the database
	 * @param name
	 * @return
	 */
	...
	/**
	 * initializes the student index to keep track of the student logging in
	 * @param name
	 */
	...
	/**
	 * removes a prof fro the database
	 * @param name
	 */
	...
	/** writes the profs to a text file
	 * @param profList
	 */
	...
	/** determine if a profs pass is in the system
	 * @param pass
	 * @return
	 */
	...
	/** determine if a profs name is in the system
	 * @param name
	 * @return
	 */
	...
	/** initialize an index to determine whihc prof is logged in
	 * @param name
	 */
	...
	/** main method implements application
	 * @param args
	 */
	public static void main(String[] args) {
		...
		do {
			...
			case 3:
				...
				/**
				 * String verify = JOptionPane.showInputDialog("Enter the administrator
				 * password: ");
				 * 
				...
				do {
					...
					if (adminChoice == 1) {
						...
						while (n1 == 0) {
							...
							n1 = JOptionPane.showConfirmDialog(null,
									"Would you like to add another course for this student", "add course",
									JOptionPane.YES_NO_OPTION);
						}
						...
						int n1 = JOptionPane.showConfirmDialog(null,
								"Would you like to add a course for this professor?", "add course",
								JOptionPane.YES_NO_OPTION);
						// System.out.println(n1);
						while (n1 == 0) {
							course = JOptionPane.showInputDialog("Enter the name of the course you would like to add");
							addNew.addCourse(course);
							n1 = JOptionPane.showConfirmDialog(null,
									"Would you like to add another course for this professor?", "add course",
									JOptionPane.YES_NO_OPTION);
						}
