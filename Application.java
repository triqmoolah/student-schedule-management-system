...
public class Application {
	...
	public static void writeStudentsToFile(ArrayList<Student> studentList) {
		...
		try {
			...
			for (int i = 0; i < size; i++) {
				String str = studentList.get(i).getFname().toString() + " " + 
							 studentList.get(i).getLname().toString() + " " + 
							 studentList.get(i).getId().toString() + " " +
						     studentList.get(i).getPassword().toString();
				writer.write(str);
				if (i < (size - 1))
					writer.write("\n");
	...
	public static void writeProfsToFile(ArrayList<Professor> profList) {
		...
		try {
			...
			for (int i = 0; i < size; i++) {
				String str = profList.get(i).getFname().toString() + " " + 
							 profList.get(i).getLname().toString() + " " + 
							 profList.get(i).getId().toString() + " " +
						     profList.get(i).getPassword().toString();
				writer.write(str);
				if (i < (size - 1))
					writer.write("\n");
