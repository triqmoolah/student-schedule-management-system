...
public class Application {
	...
	private static FileWriter studentDBFile;
	private static int studentIndex;
	private static ArrayList<Student> studentdb = new ArrayList<Student>();
	
	private static FileWriter profDBFile;
	...
	public static String viewCourseDB() {
		...
		try {
			String path = "./studentDB.txt";
			studentDBFile = new FileWriter(path);
			studentDBFile.write(txt);
		} catch(IOException e) {
			e.printStackTrace();
		}
